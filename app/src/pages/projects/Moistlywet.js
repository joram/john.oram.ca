...
function Moistlywet() {
    ...
    return (<BasePage title={title}>
        ...
        During a lunch hour a week, we'd have "soldeirng club", where those of us with side projects, circuitry related or not, would meet, discuss progress and blockers, and, of course, solder.
